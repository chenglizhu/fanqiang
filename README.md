...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/chenglizhu/fanqiang.git)
...
|**端口**|443|
|**用户ID**|2e843a11-ea02-42ff-8e23-d1ff59f8c29e>**注意：务必使用自己创建的UUID。不要使用本项目中示范的UUID！**|
|**流控**|n/a|
|**加密**|none|
|**传输协议**|ws|
|**伪装类型**|none|
...
|**地址**|优选IP<br>应用名.heroku.com|
|**端口**|443|
|**用户ID**|2e843a11-ea02-42ff-8e23-d1ff59f8c29e<br>**注意：务必使用自己创建的UUID。不要使用本项目中示范的UUID！**|
|**流控**|n/a|
|**加密**|none|
|**传输协议**|ws|
|**伪装类型**|none|
